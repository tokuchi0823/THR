...
ActiveRecord::Schema.define(version: 20200408065840) do
  ...
  create_table "plans", force: :cascade do |t|
    ...
    t.string "picture"
    t.string "contact"
    t.boolean "avoidferries", default: false
    t.boolean "avoidhighways", default: false
    t.boolean "avoidtolls", default: false
  end
