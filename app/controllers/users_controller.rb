class UsersController < ApplicationController
  ...
  def insert
   ...
   def user_params
    params.require(:user).permit(:name, :email, :department, :password, :password_confirmation, :employee_number, :uid, :designated_work_start_time, :designated_work_end_time, :basic_time, :bike, :displacement, :intercom, :etc, :continuous_cruising_distance, :navi, :image)
   end
   
   def basic_info_params
    params.require(:user).permit(:basic_time, :work_time, :bike)
   end
